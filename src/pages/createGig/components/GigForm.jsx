...
import { Form, Input, Upload, Button, Cascader, InputNumber, Alert } from "antd";
			...
			<Form className="w-1/3">
				...
				<Form.Item className="mt-2 mb-10">
					<Input
						...
						size="large"
						type="text"
						className="h-28 w-52 hover:border-gray-700"
					/>
				</Form.Item>
				<span className="font-semibold text-base custom-span">Descripcion</span>
				{/* <ReactQuill className="h-[250px] mb-16 mt-2" theme="snow" value={value} onChange={setValue} /> */}
				<span className="font-semibold text-base custom-span">Sector del servicio</span>
				<Form.Item className="mt-2 mb-10">
					<Cascader style={{ fontSize: "bold" }} options={options1} onChange={handlestateCascader} />
				</Form.Item>
				<div className="flex gap-[125px]">
					<div>
						<span className="font-semibold text-base custom-span">Celular</span>
						<Form.Item className="mt-2 mb-10">
							<Input name="phone" onChange={handleStateInputs} size="large" type="phone" />
						</Form.Item>
					</div>
					<div>
				...
				<Form.Item className="mt-2 mb-10">
					<GigFromTag className="w-full" selected={handleStateSelected} max={5} />
				</Form.Item>
				{/* <Form.Item className='mt-2 mb-10'> */}
				<div className="mt-2 mb-10">
					<ImgCrop aspect={5 / 3} showGrid>
						<Upload maxCount={1} accept=".jpge, .png" customRequest={customRequest}>
							<Button size="large"> Imagen de portada</Button>
						</Upload>
					</ImgCrop>
				</div>
				{/* </Form.Item> */}
				<Button onClick={sendData} className="w-full " size="large" htmlType="button">
					Registrar
				</Button>
			</Form>
		</div>
